...
# Form implementation generated from reading ui file 'cera.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.upload_main_pay_contract_pb = QtWidgets.QPushButton(self.upload_main_page)
        self.upload_main_pay_contract_pb.setObjectName("upload_main_pay_contract_pb")
        self.verticalLayout_11.addWidget(self.upload_main_pay_contract_pb)
        ...
        self.transition_page = QtWidgets.QWidget()
        self.transition_page.setObjectName("transition_page")
        self.verticalLayout_21 = QtWidgets.QVBoxLayout(self.transition_page)
        self.verticalLayout_21.setObjectName("verticalLayout_21")
        self.verticalLayout_20 = QtWidgets.QVBoxLayout()
        self.verticalLayout_20.setObjectName("verticalLayout_20")
        spacerItem12 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_20.addItem(spacerItem12)
        self.transition_label = QtWidgets.QLabel(self.transition_page)
        self.transition_label.setAlignment(QtCore.Qt.AlignCenter)
        self.transition_label.setObjectName("transition_label")
        self.verticalLayout_20.addWidget(self.transition_label)
        spacerItem13 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_20.addItem(spacerItem13)
        self.transition_okay_pb = QtWidgets.QPushButton(self.transition_page)
        self.transition_okay_pb.setObjectName("transition_okay_pb")
        self.verticalLayout_20.addWidget(self.transition_okay_pb)
        spacerItem14 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_20.addItem(spacerItem14)
        self.verticalLayout_21.addLayout(self.verticalLayout_20)
        self.stackedWidget.addWidget(self.transition_page)
        ...
        self.progress_bar_page = QtWidgets.QWidget()
        self.progress_bar_page.setObjectName("progress_bar_page")
        self.verticalLayout_19 = QtWidgets.QVBoxLayout(self.progress_bar_page)
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.verticalLayout_18 = QtWidgets.QVBoxLayout()
        self.verticalLayout_18.setObjectName("verticalLayout_18")
        spacerItem15 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_18.addItem(spacerItem15)
        self.progress_bar_page_label = QtWidgets.QLabel(self.progress_bar_page)
        self.progress_bar_page_label.setText("")
        self.progress_bar_page_label.setObjectName("progress_bar_page_label")
        self.verticalLayout_18.addWidget(self.progress_bar_page_label)
        spacerItem16 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_18.addItem(spacerItem16)
        self.progress_bar_page_progress_bar = QtWidgets.QProgressBar(self.progress_bar_page)
        self.progress_bar_page_progress_bar.setProperty("value", 24)
        self.progress_bar_page_progress_bar.setObjectName("progress_bar_page_progress_bar")
        self.verticalLayout_18.addWidget(self.progress_bar_page_progress_bar)
        spacerItem17 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_18.addItem(spacerItem17)
        self.verticalLayout_19.addLayout(self.verticalLayout_18)
        self.stackedWidget.addWidget(self.progress_bar_page)
        ...
        self.logo.setText("")
        self.logo.setPixmap(QtGui.QPixmap(":/gui/resources/cera.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.main_welcome_label.setText(_translate("MainWindow", "Welcome to CERA"))
        self.main_show_files_pb.setText(_translate("MainWindow", "Show My Files"))
        self.main_upload_files_pb.setText(_translate("MainWindow", "Upload File"))
        self.main_logout_pb.setText(_translate("MainWindow", "Logout"))
        self.groupbox_showfiles.setTitle(_translate("MainWindow", "Files stored on CERA"))
        ...
        self.upload_main_request_contract_pb.setText(_translate("MainWindow", "Buy Seeds"))
        ...
        self.upload_main_pay_contract_pb.setText(_translate("MainWindow", "Pay Contract"))
        ...
        self.transition_label.setText(_translate("MainWindow", "TextLabel"))
        self.transition_okay_pb.setText(_translate("MainWindow", "Okay"))
        self.login_information_label.setText(_translate("MainWindow", "Please log in to your CERA account"))
...
try:
    import cera_logo_rc          # when run from the project root (e.g. python main.py)
except ImportError:
    from gui import cera_logo_rc  # when gui.ui is imported as part of the gui package
